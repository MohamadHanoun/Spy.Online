export const SPY_DATA = {
  ...
  items: {
    ...
    video_games: [
      "Grand Theft Auto", "Call of Duty", "Battlefield", "Counter-Strike", "Valorant", "League of Legends", "Dota", "Minecraft", "Fortnite", "Roblox", "EA Sports FC", "PUBG", "Apex Legends", "Overwatch", "Rainbow Six Siege", "Rocket League", "Mario", "Pokémon", "The Legend of Zelda", "Animal Crossing", "Sonic the Hedgehog", "Crash Bandicoot", "Spyro", "God of War", "The Last of Us", "Uncharted", "Red Dead Redemption", "Assassin's Creed", "Far Cry", "Resident Evil", "Silent Hill", "Tomb Raider", "Metal Gear Solid", "Final Fantasy", "Kingdom Hearts", "Persona", "Elden Ring", "Dark Souls", "Sekiro", "Bloodborne", "The Witcher", "Cyberpunk 2077", "Diablo", "World of Warcraft", "StarCraft", "Hearthstone", "Halo", "Gears of War", "Forza", "Need for Speed", "Gran Turismo", "The Sims", "Terraria", "Among Us", "Fall Guys", "Dead by Daylight", "Monster Hunter", "Street Fighter", "Mortal Kombat", "Tekken", "Dragon Ball", "Naruto", "Yu-Gi-Oh!", "Destiny", "Warframe", "Paladins", "Brawl Stars", "Clash of Clans", "Clash Royale", "Subway Surfers", "Temple Run", "Five Nights at Freddy's", "Phasmophobia", "Left 4 Dead", "Portal", "Half-Life", "Watch Dogs", "Hitman", "Mafia", "Max Payne", "Prince of Persia", "Splinter Cell", "BioShock", "Borderlands", "Cuphead", "Hollow Knight", "Celeste", "Hades", "Stardew Valley", "Sea of Thieves", "Fallout", "Skyrim", "Doom", "Quake", "Crysis", "Ratchet & Clank", "Jak and Daxter", "LittleBigPlanet", "Sly Cooper", "Ghost of Tsushima", "Marvel's Spider-Man", "Alan Wake", "Control", "Undertale", "Geometry Dash", "Genshin Impact", "Honkai: Star Rail", "Path of Exile", "RuneScape"
    ],
  },
};