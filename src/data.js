export const SPY_DATA = {
  ...
  items: {
    places: [
      "مستشفى","صيدلية","عيادة","مخبر تحاليل","مركز إسعاف","مشفى خاص",
      "مدرسة","جامعة","روضة أطفال","مكتبة عامة","مركز ثقافي","معهد",
      "حديقة عامة","منتزه","ملعب","نادي رياضي","مسبح","صالة ألعاب",
      "سوق","سوبرماركت","بقالية","مخبز","فرن مناقيش",
      "مطعم","مقهى","كافتيريا","محل حلويات","محل شاورما","محل فلافل",
      "محل خضرة","محل لحمة","محل ألبان وأجبان","محل ملابس","محل أحذية",
      "مول","محل موبايلات","محل صيانة","مغسلة سيارات","محطة وقود",
      "كراج","محطة باص","محطة قطار","مطار","ميناء",
      "بنك","صراف آلي","شركة حوالات","مكتب بريد",
      "قسم شرطة","مخفر","بلدية","مركز دفاع مدني","مركز شرطة مرور",
      "مسجد","كنيسة","مقبرة","ساحة عامة","دوّار",
      "صالون حلاقة","مركز تجميل","مغسلة","خياط","ورشة نجارة","ورشة حدادة",
      "سيرك","مدينة ملاهي","سينما","مسرح","متحف","معرض"
    ],

    foods: [
      "شاورما","فلافل","حمص بطحينة","متبل","تبولة","فتوش",
      "كبة مقلية","كبة لبنية","كبة نية","يبرق","محشي ",
      "ورق عنب","مجدرة","فريكة","منسف","مقلوبة","رز بالشعيرية",
    ...
    animals: [
      "قط","كلب","حصان","حمار","جمل","غزال",
      "ذئب","ثعلب","أسد","نمر","فيل","زرافة",
    ...
    objects: [
      "مفتاح","هاتف","شاحن","سماعة","كمبيوتر","كيبورد",
      "كرسي","طاولة","كنباية","مخدة","بطانية","مروحة",
      "براد","غاز","فرن","غسالة","ميكروويف","صحن",
      "كاسة","ملعقة","شوكة","سكين","طنجرة","إبريق",
      "دفتر","قلم","براية","ممحاة","كتاب","حقيبة",
      "نظارة","ساعة","محفظة","مقص","صمغ","شريط لاصق",
      "شمسية","ولاعة","مسبحة","مرآة","قنينة مي","مصفاة","فوطة نسائية",
    ],
